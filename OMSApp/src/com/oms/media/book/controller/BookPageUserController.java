...
public class BookPageUserController extends UserMediaPageController{
	public BookPageUserController() {
		super();
	}
	public BookPageUserController(CartController cartController) {
