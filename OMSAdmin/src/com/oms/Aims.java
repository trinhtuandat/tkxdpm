...
import com.oms.bean.media.Track;
...
//		Register the new listener with dvd1
		dvd1.addPropertyChangeListener(mpl);
...
//		Decrease the cost of dvd1
		...
		cd1.addVetoableChangeListener(mcl);
		book.addVetoableChangeListener(mcl);
		cd1.setCategory("Heavy metal");
